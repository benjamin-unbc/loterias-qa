...
<div x-data="{ show: @entangle($attributes->wire('model')) }" x-show="show" id="{{ $id }}"
    ...
    <div x-show="show"
        class="mb-6 bg-[#22272b] rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
