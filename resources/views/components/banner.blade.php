...
@php
    // Limpiar los mensajes flash de la sesión después de leerlos
    if (session()->has('flash.banner')) {
        session()->forget(['flash.banner', 'flash.bannerStyle']);
    }
@endphp

<div class="absolute z-50 right-4 rounded bottom-4 w-1/4"
    ...
    <div class="max-w-screen-sm mx-auto py-2 px-3 sm:px-6 lg:px-8">
